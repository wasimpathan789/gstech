      ...
      <div className="itConsulting">
        <div className="itCotainerLeft">
          ...
          <ParagraphContainer
            animation={"fade-right"}
            text={
              " GS Technology creates strategies to move you in the direction of achieving your vision, align every aspect of your organization to support them, including your systems and processes.  "
            }
          />
          <h2>Here are three key tips to get you started:</h2>
          <div
            style={{
              padding: "20px 10px",
              display: "flex",
